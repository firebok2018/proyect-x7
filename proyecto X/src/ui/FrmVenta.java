...
public class FrmVenta extends JInternalFrame implements ActionListener {
	...
	public FrmVenta() {
		...
		txtCantidadPedido.setBounds(98, 159, 45, 20);
		getContentPane().add(txtCantidadPedido);
		txtCantidadPedido.setColumns(10);
		
		btnAgregar = new JButton("Agregar");
		btnAgregar.setFocusable(false);
		btnAgregar.setBorder(new MatteBorder(1, 1, 1, 1, (Color) new Color(255, 165, 0)));
		...
		tblVenta = new JTable();
		tblVenta.setGridColor(new Color(30, 144, 255));
		tblVenta.setBorder(new MatteBorder(0, 0, 0, 0, (Color) new Color(0, 0, 0)));
		...
		btnModificar.setBorder(new MatteBorder(1, 1, 1, 1, (Color) new Color(255, 165, 0)));
	...
	String tipo(){return cboTipo.getSelectedItem().toString().trim();}
														...
														try {
															...
															if(nc<1){
																...
																try{
																	...
																	String usr="WISDS";
																	if(usr.length()!=0){
																		Venta xd= new Venta(c, cc,n+" "+a,t,p,nc,usr);
																		conVen.update_venta(xd);
																		listar();
																	}else{
																		mensaje("Error al Insertar Registro");
																	}
	...
	void eliminarVenta(){
		System.out.println("Eliminado");
				String xd="WISDS";
				Venta xy= new Venta(CodVenta(),xd);
				conVen.delete_venta(xy);
				listar();
